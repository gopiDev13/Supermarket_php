        ...
        <div class="table-wrapper">
            ...
            <table class="table table-bordered">
                ...
                if ($result->num_rows > 0) {
                    ...
                    <td>" . getSubcategoryName($row['sub_category_id']) . "</td>
                   ...
                   <a href='viewproducts.php?id=" . $row['id'] . "'><i class='bi-eye-fill'></i></a>
                   <a href='editproducts.php?id=" . $row['id'] . "'><i class='bi-pencil'></i></a>
                   <a href='deletepro.php?id=" . $row['id'] . "'><i class='bi-trash'></i></a>
