        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                    <a href="addadminpage.php"><button type="button" class="btn btn-info add-new"><i class="fa fa-plus"></i> Add New</button></a>
                    </div>
                </div>
            </div>
            <table class="table table-bordered">
                ...
                include_once "../functions/orderdata.php";
                ...
                if ($result->num_rows > 0) {
                   ...
                   <a href='deleteadd.php?id=" . $row['id'] . "'><i class='bi-trash'></i></a>
